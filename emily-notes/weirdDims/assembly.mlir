...
scf_body_0_for:
    ...
    add t4, t0, t4
    fld ft6, 0(t4)                               # load double from memref of shape (1, 600)
    li t4, 4
    mul t4, t1, t4
    addi t4, t4, 1
    li t5, 8
    mul t4, t4, t5                               # multiply by element size
    add t4, t0, t4
    fld ft5, 0(t4)                               # load double from memref of shape (1, 600)
    li t4, 4
    mul t4, t1, t4
    addi t4, t4, 2
    li t5, 8
    mul t4, t4, t5                               # multiply by element size
    add t4, t0, t4
    fld ft4, 0(t4)                               # load double from memref of shape (1, 600)
    li t4, 4
    mul t4, t1, t4
    addi t4, t4, 3
    li t5, 8
    mul t4, t4, t5                               # multiply by element size
    add t4, t0, t4
    fld ft3, 0(t4)                               # load double from memref of shape (1, 600)
    li t4, 599
    frep.o t4, 4, 0, 0
    ...
    mul t4, t4, t5                               # multiply by element size
    add t4, t0, t4
    fsd ft6, 0(t4)                               # store double value to memref of shape (1, 600)
    li t4, 4
    mul t4, t1, t4
    addi t4, t4, 1
    li t5, 8
    mul t4, t4, t5                               # multiply by element size
    add t4, t0, t4
    fsd ft5, 0(t4)                               # store double value to memref of shape (1, 600)
    li t4, 4
    mul t4, t1, t4
    addi t4, t4, 2
    li t5, 8
    mul t4, t4, t5                               # multiply by element size
    add t4, t0, t4
    fsd ft4, 0(t4)                               # store double value to memref of shape (1, 600)
    li t4, 4
    mul t4, t1, t4
    addi t4, t4, 3
    li t5, 8
    mul t4, t4, t5                               # multiply by element size
    add t4, t0, t4
    fsd ft3, 0(t4)                               # store double value to memref of shape (1, 600)
    addi t1, t1, 1
